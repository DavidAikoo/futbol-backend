...
public class EntrenadorController {
    ...
    public ResponseEntity<Entrenador> save(@Valid @RequestBody Entrenador entrenador) {
    ...
    public ResponseEntity<?> update(@PathVariable Long id, @Valid @RequestBody Entrenador entrenador) {
        try {
